...
var Random = axecore.crypto.Random;
...
// These tests require a running axed instance
describe('Integration with ' + network.name + ' axed', function() {
